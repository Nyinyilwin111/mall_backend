...
public interface PaymentRepository extends JpaRepository<Payment, Long> {
    ...
    @Query("SELECT p FROM Payment p WHERE p.utility.utilityId = :utilityId")
    List<Payment> findAllByUtilityId(@Param("utilityId") Long utilityId);
    ...
    @Query("SELECT p FROM Payment p WHERE p.utility.space.spaceId = :spaceId")
    List<Payment> findAllBySpaceId(@Param("spaceId") UUID spaceId);
}