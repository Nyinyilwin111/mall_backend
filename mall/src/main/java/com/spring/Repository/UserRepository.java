...
public interface UserRepository extends JpaRepository<User, UUID> {
    ...
    // this method is for data initializer
    @Query("SELECT u FROM User u WHERE u.fullName = :fullName")
    Optional<User> findByName(@Param("fullName") String fullName);
...
//    List<User> findByBranch(Branch branch);
    ...
    @Query("SELECT ub.user FROM UserBranch ub WHERE ub.branch = :branch")
