...
public class UserServiceImplement implements UserService {
    ...
    public List<User> searchUserByName(String name) {
        System.out.println("🔍 Searching users by name/email: '" + name + "'");

        // Use the same search logic as searchUser method
        List<User> users = userRepository.searchByFullNameOrEmail(name).stream()
                .sorted(Comparator.comparing(User::getFullName))
                .toList();
